        ...
        <div className="flex relative bg-[#F3F3F3] -ml-4 w-full md:h-[645px] h-[850px] rounded-3xl overflow-hidden">
          ...
          <div className="w-full sm:w-1/2 relative h-full">
            ...
            <div className="absolute left-0 top-0 h-full w-full sm:hidden z-10"
              style={{ background: 'linear-gradient(180deg, #F3F3F3 0%, rgba(243,243,243,1) 20%, rgba(243,243,243,0) 100%)' }}
            />
          </div>
        </div>
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 bottom-[200px] sm:bottom-4 w-[80%] max-w-[1300px] h-auto border border-white/100 rounded-2xl backdrop-blur-[10px] bg-[#0000000D]/70 flex flex-col sm:flex-row justify-between items-center px-4 py-4 gap-4 z-30 shadow-[0px_4px_11.6px_0px_#00000026]">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-6 text-[#3C3C3C]">
            <div className="flex items-center gap-8 text-[#3C3C3C]">
              <svg width="25" height="29" viewBox="0 0 25 29" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative -top-[24px] left-[24px]">
                <path d="..." stroke="#3C3C3C" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
