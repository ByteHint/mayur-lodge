...
export default function Hero() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-[#FFFFFF]">
      <div className="w-full mx-auto px-4 sm:px-6 md:px-10 lg:px-16 pl-12 sm:pl-0">
        <div className="flex relative bg-[#F3F3F3] -ml-4 w-full md:h-[645px] h-[410.673828125px] top-[20px] sm:top-0 rounded-3xl overflow-hidden">
          {/* Desktop Version */}
  ...
  <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-10 text-[#3C3C3C]">
    ...
    <button
      ...
      className={`${aderoTrial.className} flex items-center gap-2 px-6 py-4 bg-[#3C3C3C] text-[#F3F3F3] md:bg-[#F3F3F3] md:text-[#3C3C3C] hover:scale-105 transition-all duration-300 ease-in-out text-sm font-semibold rounded-[15px] border border-[#FFFFFF4D] shadow-md hover:shadow-lg mx-auto md:mr-4`}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
