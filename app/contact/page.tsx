...
return (
    ...
    <h1 className="text-4xl font-bold py-4 text-center">Contact Us</h1>
    ...
    <div className="max-w-96 w-full px-4">
        ...
        <button type="submit" className="flex items-center justify-center gap-1 mt-5 bg-indigo-500 hover:bg-indigo-600 text-white py-2.5 w-full rounded-full transition cursor-pointer">
            Submit Form
